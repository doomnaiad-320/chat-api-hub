    ...
    try {
      ...
      for (let i = 0; i < batchAddCount; i++) {
        ...
        if (adjustedValues.unlimited_quota) {
          ...
          adjustedValues.remain_quota =
            parseFloat(adjustedValues.remain_quota) * quotaPerUnit;
        }
      ...
      if (failedSubmissions.length > 0) {
        const message = failedSubmissions
        ...
        >
          {({
            ...
            <form noValidate onSubmit={handleSubmit}>
              ...
              <FormControl
                fullWidth
                sx={{ ...theme.typography.otherInput, mt: 2 }}
              >
                <InputLabel htmlFor='models-multiple-select'>
                  可用模型
                </InputLabel>
                <Select
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                      {selected.map((value) => (
                        <Chip
                          ...
                          label={value}
                          onDelete={() => {
                            const newSelected = values.models.filter(
                              (model) => model !== value
                            );
                ...
                : modelRatioEnabled &&
                  billingByRequestEnabled && (
                    <FormControl
                      ...
                      sx={{ ...theme.typography.otherInput }}
                    >
                      <InputLabel id='billing-enabled-label'>
                        计费方式
                      </InputLabel>
                      <Select
              ...
              <FormControl
                fullWidth
                error={Boolean(touched.fixed_content && errors.fixed_content)}
                sx={{ ...theme.typography.otherInput }}
              >
                <InputLabel htmlFor='channel-fixed_content-label'>
                  自定义后缀
                </InputLabel>
                <OutlinedInput
                  id='channel-name-label'
                ...
                {touched.fixed_content && errors.fixed_content && (
                  <FormHelperText
                    error
                    id='helper-tex-channel-fixed_content-label'
                  >
