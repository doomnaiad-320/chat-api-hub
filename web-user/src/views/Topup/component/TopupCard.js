  ...
  const renderTopUpAmountInput = () => {
    ...
    return (
      <FormControl fullWidth variant='outlined' sx={{ mt: 2, mb: 1 }}>
        ...
        >
          <Box sx={{ flexGrow: 1 }}>{amountInputComponent}</Box>
    ...
    >
      ...
      <FormControl fullWidth sx={{ mb: 2 }}>
        ...
        <Select
          ...
          onChange={(e) =>
            setAlertSettings({ ...alertSettings, min_quota: e.target.value })
          }
        >
