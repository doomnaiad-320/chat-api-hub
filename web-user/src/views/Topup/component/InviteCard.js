            ...
            >
              ...
              <Box sx={{ mt: 4 }}>
                <Button
                  ...
                  disabled={
                    !withdrawalAmount ||
                    withdrawalAmount < Number(options.MiniQuota) ||
                    !alipayAccount
                  }
                  sx={{
                    ...commonButtonSx,
            ...
            >
              ...
              >
                <Button
                  ...
                  disabled={
                    !transferAmount ||
                    transferAmount < Number(options.MiniQuota) ||
                    transferAmount >
                      parseQuotaStringToNumber(inviteQuota(userAffQuota))
                  }
                  sx={{
                    ...commonButtonSx,
                    background:
