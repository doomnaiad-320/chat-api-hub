...
function renderType(type) {
  switch (type) {
    ...
    case 'MODAL':
      return (
        <Label
          style={{ color: colors[2], borderColor: colors[2] }}
          size='small'
          variant='outlined'
        >
          窗口确认
    ...
    case 'UPSCALE':
      return (
        <Label
          style={{ color: colors[4], borderColor: colors[4] }}
          size='small'
          variant='outlined'
        >
          放大
    ...
    case 'VARIATION':
      return (
        <Label
          style={{ color: colors[5], borderColor: colors[5] }}
          size='small'
          variant='outlined'
        >
          变换
    ...
    case 'DESCRIBE':
      return (
        <Label
          style={{ color: colors[6], borderColor: colors[6] }}
          size='small'
          variant='outlined'
        >
          图生文
    ...
    case 'REROLL':
      return (
        <Label
          style={{ color: colors[7], borderColor: colors[7] }}
          size='small'
          variant='outlined'
        >
          重绘
    ...
    case 'BLEND':
      return (
        <Label
          style={{ color: colors[8], borderColor: colors[8] }}
          size='small'
          variant='outlined'
        >
          图混合
    ...
    default:
      return (
        <Label
          style={{ color: colors[9], borderColor: colors[9] }}
          size='small'
          variant='outlined'
        >
          未知
...
function renderCode(code) {
  switch (code) {
    case 1:
      return (
        <Label
          style={{ color: colors[10], borderColor: colors[10] }}
          size='small'
          variant='outlined'
        >
          已提交
    ...
    case 21:
      return (
        <Label
          style={{ color: colors[11], borderColor: colors[11] }}
          size='small'
          variant='outlined'
        >
          等待中
    ...
    case 22:
      return (
        <Label
          style={{ color: colors[12], borderColor: colors[12] }}
          size='small'
          variant='outlined'
        >
          排队中
    ...
    default:
      return (
        <Label
          style={{ color: colors[13], borderColor: colors[13] }}
          size='small'
          variant='outlined'
        >
          未知
...
function renderMode(type) {
  switch (type) {
    case 'turbo':
      return (
        <Label
          style={{ color: colors[14], borderColor: colors[14] }}
          size='small'
          variant='outlined'
        >
          Turbo
    ...
    case 'relax':
      return (
        <Label
          style={{ color: colors[15], borderColor: colors[15] }}
          size='small'
          variant='outlined'
        >
          Relax
    ...
    case 'fast':
      return (
        <Label
          style={{ color: colors[16], borderColor: colors[16] }}
          size='small'
          variant='outlined'
        >
          Fast
    ...
    default:
      return (
        <Label
          style={{ color: colors[17], borderColor: colors[17] }}
          size='small'
          variant='outlined'
        >
          未知
...
function renderStatus(type) {
  switch (type) {
    case 'SUCCESS':
      return (
        <Label
          style={{ color: colors[18], borderColor: colors[18] }}
          size='small'
          variant='outlined'
        >
          成功
    ...
    case 'NOT_START':
      return (
        <Label
          style={{ color: colors[19], borderColor: colors[19] }}
          size='small'
          variant='outlined'
        >
          未启动
    ...
    <TableRow key={item.id}>
      ...
      <TableCell>
        <Tooltip title={item.prompt_en || '无'} placement='top' arrow>
          ...
          >
            {item.prompt_en
              ? item.prompt_en.substring(0, 10) +
                (item.prompt_en.length > 10 ? '...' : '')
              : '无'}
          </div>
        </Tooltip>
      </TableCell>
      <TableCell>
        <Tooltip title={item.fail_reason || '无'} placement='top' arrow>
          ...
          >
            {item.fail_reason
              ? item.fail_reason.substring(0, 10) +
                (item.fail_reason.length > 10 ? '...' : '')
              : '无'}
          </div>
        </Tooltip>
      </TableCell>
